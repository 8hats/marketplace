...
Use `AU_OURS_CONFIG=/absolute/path/project.json` when the harness uses a different
working directory. A complete environment URL/token pair overrides project
