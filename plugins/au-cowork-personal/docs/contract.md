...
The original surface had ten tools. Owner #347 removes the five old message/file tools; the current surface is foreground wait, five session tools plus 16 Personal Agent ac_* tools (Owner #351/#370), as documented in [product tools](product-tools.md). One stdio process binds at most one room.
