...
const roomBriefing = z.object({ ...common, kind: z.literal('room_briefing'), message_id: z.string().min(1), briefing_version: z.number().int().positive(), text: z.string() }).strict();
const envelope = z.discriminatedUnion('kind', [roomMessage, roomFile, roomBriefing]);
