...
The original surface had ten tools. Owner #347 removes the five old message/file tools; the current surface is five session tools plus21 ac_* tools, as documented in [product tools](product-tools.md). One stdio process binds at most one room.
