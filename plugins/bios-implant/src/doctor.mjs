...
async function inspectPackageInventory(packageRoot, deps) {
  ...
  const requiredPaths = [
    ...
    ["SKILL_INSTALL_PRESENT", path.join(packageRoot, "skills", "8hats-implant-install", "SKILL.md")],
    ["SKILL_CONNECT_PRESENT", path.join(packageRoot, "skills", "8hats-implant-connect", "SKILL.md")],
    ["SKILL_BOOT_PRESENT", path.join(packageRoot, "skills", "8hats-implant-boot", "SKILL.md")],
    ["SKILL_DOCTOR_PRESENT", path.join(packageRoot, "skills", "8hats-implant-doctor", "SKILL.md")],
